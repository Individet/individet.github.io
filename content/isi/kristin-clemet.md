...
tags:
  ...
  - DLD
scores:
  d1: { total: 0, d1_1: 0, d1_2: 0, d1_3: 1, d1_4: -1 }
  d2: { total: 6, d2_1: 2, d2_2: 1, d2_3: 2, d2_4: 1 }
  d3: { total: 7, d3_1: 2, d3_2: 1, d3_3: 1, d3_4: 1, d3_5: 2, d3_6: 0 }
  d4: { total: 5, d4_1: 2, d4_2: 1, d4_3: 1, d4_4: 1 }
  d5: { total: 5, d5_1: 2, d5_2: 1, d5_3: 2, d5_4: 0 }
  d6: { total: 2, d6_1: 2, d6_2: 0, d6_3: 0, d6_4: 0 }
---
...
Historisk sterk frihetsorientering: «Hvis vi mener at det bør være fri flyt av varer og tjenester, bør det prinsipielt også gjelde for mennesker» (Dagsavisen/E24 2008). Ga ut boken _De nye seierherrene_ (2012) med liberalt innvandringsperspektiv. Har imidlertid offentlig moderert sin posisjon: «Jeg er blant dem som har forandret mening i deler av innvandrings- og integreringspolitikken» (Aftenposten). Erkjente at Høyre-leder Jan Petersen hadde hatt rett om integreringsutfordringene. Under pandemien støttet hun SVs krav om parlamentarisk prøving av koronatiltak (clemet.blogg.no 27.10.2020). Trekkes fra +2 til +1 pga. offentlig posisjonskorreksjon.
